...
//         typename Size1,
//         typename Size2>
//  void get_set_union_splitter_ranks(RandomAccessIterator1 first1,
...
//} // end get_set_union_splitter_ranks()
//
//
...
//    return result;
//
//  using namespace set_union_detail;
//  using namespace thrust::detail;
//  using namespace thrust::detail::device::cuda::detail;
//
...
//  get_set_union_splitter_ranks(first1,last1,
//                               first2,last2,
...
//  const size_t dynamic_smem_size = get_set_union_kernel_per_block_dynamic_smem_usage<RandomAccessIterator1,RandomAccessIterator2,typename raw_buffer<value_type1,cuda_device_space_tag>::iterator>(block_size);
//
//  set_union_detail::set_union_kernel<<<num_blocks, static_cast<unsigned int>(block_size), static_cast<unsigned int>(dynamic_smem_size)>>>( 
//  	first1, last1,
//        first2, last2,
//  	splitter_ranks1.begin(),
//  	splitter_ranks2.begin(),
...
//  synchronize_if_enabled("set_union_kernel");
//
