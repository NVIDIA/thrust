                       ...
                       RandomAccessIterator last)
{
    ...
    thrust::detail::device::cuda::detail::b40c_thrust::RadixSortingEnactor<K> sorter(num_elements);
    thrust::detail::device::cuda::detail::b40c_thrust::RadixSortStorage<K>    storage;
                              ...
                              thrust::detail::true_type)
{
    ...
    thrust::detail::device::cuda::detail::b40c_thrust::RadixSortingEnactor<K,V> sorter(num_elements);
    thrust::detail::device::cuda::detail::b40c_thrust::RadixSortStorage<K,V>    storage;
