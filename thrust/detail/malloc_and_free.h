...
pointer<void,System> malloc(thrust::system::detail::dispatchable<System> &system, std::size_t n)
{
...
void free(thrust::system::detail::dispatchable<System> &system, Pointer ptr)
{
