...
{
  System &non_const_system = const_cast<System&>(system);
  return thrust::partition(non_const_system, first, last, stencil, pred);
} // end partition()
...
{
  System &non_const_system = const_cast<System&>(system);
  return thrust::partition_copy(non_const_system, first, last, stencil, out_true, out_false, pred);
} // end partition_copy()
                            ...
                            Predicate pred)
{
  ...
  return thrust::detail::strip_const_partition(select_system(system1,system2), first, last, stencil, pred);
} // end partition()
                   ...
                   Predicate pred)
{
  ...
  return thrust::detail::strip_const_partition_copy(select_system(system1,system2,system3,system4), first, last, stencil, out_true, out_false, pred);
} // end partition_copy()
