                                      ...
                                      BlockConvergentSetOperation set_op)
{
  ...
  arch::function_attributes_t attributes = thrust::detail::backend::cuda::detail::closure_attributes<SetOperationClosure>();
  ...
  uninitialized_array<value_type1, cuda_device_space_tag>
  ...
  typedef grouped_gather_closure<BlockConvergentSetOperation,
