  ...
  struct reduce_n_smem_closure
{
  ...
  void operator()(void)
  {
    thrust::detail::backend::cuda::extern_shared_ptr<OutputType> shared_ptr;
                                  ...
                                  thrust::detail::true_type)   // reduce in shared memory
{
  ...
  const size_t block_size = thrust::detail::backend::cuda::detail::block_size_with_maximal_occupancy<Closure>(smem_per_thread);
                                                        ...
                                                        BinaryFunction binary_op)
{
  ...
  const size_t num_blocks_from_wide_part =
    thrust::detail::backend::cuda::get_unordered_blocked_standard_reduce_n_schedule(xfrm_wide_first, n_wide, init, binary_op);
                                                            ...
                                                            BinaryFunction binary_op)
{
  ...
  if(sizeof(OutputType) <= 64)
  {
    ...
    const size_t block_size = thrust::detail::backend::cuda::detail::block_size_with_maximal_occupancy<Closure>(smem_per_thread);
    const size_t smem_size = block_size * smem_per_thread;
    num_blocks = thrust::detail::backend::cuda::detail::num_blocks_with_maximal_occupancy<Closure>(n, block_size, smem_size);
  }
  else
  {
    ...
    const size_t block_size = thrust::detail::backend::cuda::detail::block_size_with_maximal_occupancy<Closure>();
    num_blocks = thrust::detail::backend::cuda::detail::num_blocks_with_maximal_occupancy<Closure>(n, block_size);
  }
                                       ...
                                       RandomAccessIterator2 result)
{
  ...
  if(num_blocks < 2)
  {
    thrust::detail::backend::cuda::unordered_blocked_standard_reduce_n(first, n, num_blocks, binary_op, result);
  } // end if
  else
  {
    ...
    thrust::detail::backend::cuda::unordered_blocked_standard_reduce_n(xfrm_wide_first, n_wide, num_wide_results, binary_op, result);

    // process tail
    thrust::detail::backend::cuda::unordered_blocked_standard_reduce_n(tail_first, n_tail, (size_t)1u, binary_op, result + num_wide_results);
  } // end else
                                  ...
                                  RandomAccessIterator2 result)
{
  ...
  return thrust::detail::backend::cuda::dispatch::unordered_blocked_reduce_n(first, n, num_blocks, binary_op, result,
                                                   ...
                                                   BinaryFunction binary_op)
{
  ...
  return thrust::detail::backend::cuda::dispatch::get_unordered_blocked_reduce_n_schedule(first, n, init, binary_op,
