...
#include <thrust/detail/backend/cuda/set_difference.inl>
#include <thrust/detail/backend/cuda/set_intersection.inl>
#include <thrust/detail/backend/cuda/set_symmetric_difference.inl>
#include <thrust/detail/backend/cuda/set_union.inl>
