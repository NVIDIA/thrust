                                       ...
                                       thrust::detail::false_type) // has_trivial_copy_constructor
{
  ...
  return thrust::detail::backend::cuda::detail::for_each_n(first, n, thrust::detail::uninitialized_fill_functor<ValueType>(x));
} // end uninitialized_fill_n()
                                       ...
                                       const T &x)
{
  ...
  return thrust::detail::backend::cuda::detail::uninitialized_fill_n(first, n, x,
