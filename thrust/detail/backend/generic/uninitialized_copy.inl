                                     ...
                                     ForwardIterator result)
{
  ...
  return thrust::detail::backend::generic::detail::uninitialized_copy(first, last, result, ResultTypeHasTrivialCopyConstructor());
} // end uninitialized_copy()
                                       ...
                                       ForwardIterator result)
{
  ...
  return thrust::detail::backend::generic::detail::uninitialized_copy_n(first, n, result, ResultTypeHasTrivialCopyConstructor());
} // end uninitialized_copy_n()
