...
template<typename InputIterator,
  ...
  OutputIterator copy_n(InputIterator first,
                        ...
                        thrust::detail::true_type)  // is_trivial_copy
{
  return thrust::detail::backend::cpp::detail::trivial_copy_n(&*first, n, &*result);
} // end copy_n()
...
template<typename InputIterator,
  ...
  OutputIterator copy(tag,
                      ...
                      OutputIterator result)
{
  return thrust::detail::backend::cpp::detail::copy(first, last, result,
...
template<typename InputIterator,
  ...
  OutputIterator copy_n(tag,
                        ...
                        OutputIterator result)
{
  return thrust::detail::backend::cpp::detail::copy_n(first, n, result,
    typename thrust::detail::dispatch::is_trivial_copy<InputIterator,OutputIterator>::type());
} // end copy_n()
