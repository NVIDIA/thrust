...
#include <thrust/detail/backend/omp/set_operations.h>
...
{
  // omp backend
  return thrust::detail::backend::omp::set_difference(first1,last1,first2,last2,result,comp);
} // end set_difference()
...
{
  // omp backend
  return thrust::detail::backend::omp::set_intersection(first1,last1,first2,last2,result,comp);
...
{
  // omp backend
  return thrust::detail::backend::omp::set_symmetric_difference(first1,last1,first2,last2,result,comp);
...
{
  // omp backend
  return thrust::detail::backend::omp::set_union(first1,last1,first2,last2,result,comp);
} // end set_union()
