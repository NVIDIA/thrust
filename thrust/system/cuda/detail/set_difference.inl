...
#include <thrust/system/cuda/detail/block/set_difference.h>
...
struct block_convergent_set_difference_functor
{
  ...
  {
    return block::set_difference(context,first1,last1,first2,last2,reinterpret_cast<int*>(temporary),result,comp);
  } // end operator()()
                                     ...
                                     Compare comp)
{
  ...
  const difference1 num_elements2 = last2 - first2;
