                        ...
                        ValueType& carry_value)
{
  ...
  block::inplace_inclusive_scan(context, sflag, thrust::plus<FlagType>());
  ...
  // second level segmented scan
  {
    ...
    if (FullBlock)
      block::inplace_inclusive_segscan(context, sflag, sdata[K-1], binary_op);
    else
      block::inplace_inclusive_segscan_n(context, sflag, sdata[K-1], n, binary_op);
  }
