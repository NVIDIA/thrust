	...
	int normal_block_elements)
{
	...
	const int LOG_PARTIALS_PER_ROW		= (LOG_PARTIALS_PER_SEG < B40C_LOG_MEM_BANKS(B40C_CUDA_ARCH)) ? B40C_LOG_MEM_BANKS(B40C_CUDA_ARCH) : LOG_PARTIALS_PER_SEG;		// floor of 32 elts per row
