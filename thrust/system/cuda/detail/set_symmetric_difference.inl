...
#include <thrust/system/cuda/detail/block/set_symmetric_difference.h>
...
struct block_convergent_set_symmetric_difference_functor
{
  ...
  {
    return block::set_symmetric_difference(context,first1,last1,first2,last2,reinterpret_cast<int*>(temporary),result,comp);
  } // end operator()()
