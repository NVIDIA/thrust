...
inline __host__ __device__
  void assign_value_msvc2005_war(thrust::cuda::dispatchable<System> &system, Pointer1 dst, Pointer2 src)
{
  // XXX war nvbugs/881631
  struct war_nvbugs_881631
  {
    __host__ inline static void host_path(thrust::cuda::dispatchable<System> &system, Pointer1 dst, Pointer2 src)
    {
      thrust::copy(system, src, src + 1, dst);
    }

    __device__ inline static void device_path(thrust::cuda::dispatchable<System> &, Pointer1 dst, Pointer2 src)
    {
  ...
  war_nvbugs_881631::host_path(system,dst,src);
#else
  war_nvbugs_881631::device_path(system,dst,src);
#endif // __CUDA_ARCH__
...
template<typename System, typename Pointer1, typename Pointer2>
inline __host__ __device__
  void assign_value(thrust::cuda::dispatchable<System> &system, Pointer1 dst, Pointer2 src)
{
  return assign_value_msvc2005_war(system,dst,src);
} // end assign_value()
