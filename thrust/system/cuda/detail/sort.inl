                   ...
                   StrictWeakOrdering comp)
{
    ...
    first_dispatch::stable_sort(system, first, last, comp);
}
                          ...
                          StrictWeakOrdering comp)
{
    ...
    first_dispatch::stable_sort_by_key(system, keys_first, keys_last, values_first, comp);
}
