...
#include <thrust/system/cpp/detail/stable_merge_sort.h>
#include <thrust/system/cpp/detail/stable_radix_sort.h>
...
{
  thrust::system::cpp::detail::stable_radix_sort(first, last);
                        ...
                        thrust::detail::true_type)
{
  ...
  thrust::system::cpp::detail::stable_radix_sort_by_key(first1, last1, first2);
...
{
  thrust::system::cpp::detail::stable_merge_sort(first, last, comp);
}
...
void stable_sort_by_key(RandomAccessIterator1 first1,
                        ...
                        thrust::detail::false_type)
{
  thrust::system::cpp::detail::stable_merge_sort_by_key(first1, last1, first2, comp);
}
