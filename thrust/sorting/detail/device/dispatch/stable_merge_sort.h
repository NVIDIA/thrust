...
#include <thrust/sorting/detail/device/omp/stable_merge_sort.h>
...
{
    thrust::sorting::detail::device::omp::stable_merge_sort(first, last, comp);
}
...
void stable_merge_sort_by_key(RandomAccessIterator1 keys_first,
                              ...
                              thrust::detail::omp_device_space_tag)
{
    thrust::sorting::detail::device::omp::stable_merge_sort_by_key(keys_first, keys_last, values_first, comp);
}
