...
template<typename DeviceBidirectionalIterator>
  struct iterator_device_reference< thrust::experimental::reverse_iterator<DeviceBidirectionalIterator> >
    : iterator_device_reference<DeviceBidirectionalIterator>
{
