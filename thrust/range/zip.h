...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<Range1,Range2,Range3,Range4>::type
    zip(Range1 &rng1,
        Range2 &rng2,
        Range3 &rng3,
        Range4 &rng4)
{
  return make_iterator_range(make_zip_iterator(make_tuple(begin(rng1), begin(rng2), begin(rng3), begin(rng4))),
                             make_zip_iterator(make_tuple(end(rng1), end(rng2), end(rng3), end(rng4))));
} // end zip()


template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<Range1,Range2,Range3,const Range4>::type
    zip(Range1 &rng1,
        Range2 &rng2,
        Range3 &rng3,
        const Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<Range1,Range2,const Range3,Range4>::type
    zip(Range1 &rng1,
        Range2 &rng2,
        const Range3 &rng3,
        Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<Range1,Range2,const Range3,const Range4>::type
    zip(Range1 &rng1,
        Range2 &rng2,
        const Range3 &rng3,
        const Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<Range1,const Range2,Range3,Range4>::type
    zip(Range1 &rng1,
        const Range2 &rng2,
        Range3 &rng3,
        Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<Range1,const Range2,Range3,const Range4>::type
    zip(Range1 &rng1,
        const Range2 &rng2,
        Range3 &rng3,
        const Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<Range1,const Range2,const Range3,Range4>::type
    zip(Range1 &rng1,
        const Range2 &rng2,
        const Range3 &rng3,
        Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<Range1,const Range2,const Range3,const Range4>::type
    zip(Range1 &rng1,
        const Range2 &rng2,
        const Range3 &rng3,
        const Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<const Range1,Range2,Range3,Range4>::type
    zip(const Range1 &rng1,
        Range2 &rng2,
        Range3 &rng3,
        Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<const Range1,Range2,Range3,const Range4>::type
    zip(const Range1 &rng1,
        Range2 &rng2,
        Range3 &rng3,
        const Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<const Range1,Range2,const Range3,Range4>::type
    zip(const Range1 &rng1,
        Range2 &rng2,
        const Range3 &rng3,
        Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<const Range1,Range2,const Range3,const Range4>::type
    zip(const Range1 &rng1,
        Range2 &rng2,
        const Range3 &rng3,
        const Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<const Range1,const Range2,Range3,Range4>::type
    zip(const Range1 &rng1,
        const Range2 &rng2,
        Range3 &rng3,
        Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<const Range1,const Range2,Range3,const Range4>::type
    zip(const Range1 &rng1,
        const Range2 &rng2,
        Range3 &rng3,
        const Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<const Range1,const Range2,const Range3,Range4>::type
    zip(const Range1 &rng1,
        const Range2 &rng2,
        const Range3 &rng3,
        Range4 &rng4)
...
template<typename Range1, typename Range2, typename Range3, typename Range4>
  typename detail::zip4_result<const Range1,const Range2,const Range3,const Range4>::type
    zip(const Range1 &rng1,
        const Range2 &rng2,
        const Range3 &rng3,
        const Range4 &rng4)
