 ...
 *  komrade::stable_reduce should be used instead.
 *
...
template<typename InputIterator> typename
  komrade::iterator_traits<InputIterator>::value_type reduce(InputIterator
 ...
 *  then komrade::stable_reduce should be used instead.
 *
 *  \param first The beginning of the input sequence.
 *  \param last The end of the input sequence.
 *  \param init The initial value.
...
#include <komrade/detail/reduce.inl>
