...
#include <komrade/iterator/counting_iterator.h>
...
template<typename T>
  struct make_device_dereferenceable< komrade::experimental::constant_iterator<T> >
{
  __host__ __device__
  static
  komrade::experimental::constant_iterator<T> &
  transform(komrade::experimental::constant_iterator<T> &x)
  {
    return x;
  } // end transform()
  ...
  __host__ __device__
  static
  const komrade::experimental::constant_iterator<T> &
  transform(const komrade::experimental::constant_iterator<T> &x)
  {
    return x;
  } // end transform()
