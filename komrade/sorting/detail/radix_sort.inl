...
#include <komrade/sorting/detail/dispatch/radix_sort.h>
                         ...
                         RandomAccessIterator end)
{
    ...
    komrade::sorting::detail::dispatch::stable_radix_sort(begin, end,
...
{
    // dispatch on iterator category
    komrade::sorting::detail::dispatch::stable_radix_sort_by_key(keys_begin, keys_end, values_begin,
            typename komrade::iterator_traits<RandomAccessIterator1>::iterator_category(),
            typename komrade::iterator_traits<RandomAccessIterator2>::iterator_category());
}
