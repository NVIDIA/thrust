                    ...
                    size_t len1, size_t len2)
{
    ...
    typename komrade::iterator_traits<RandomAccessKeyIterator>::difference_type len11 = 0;
    typename komrade::iterator_traits<RandomAccessKeyIterator>::difference_type len22 = 0;
                                ...
                                StrictWeakOrdering comp)
{
    ...
    // sort each side
    komrade::sorting::stable_merge_sort_by_key(keys_begin, keys_middle, values_begin, comp);
    komrade::sorting::stable_merge_sort_by_key(keys_middle, keys_end, values_middle, comp);
             ...
             size_t len1, size_t len2)
{
    ...
    typename komrade::iterator_traits<RandomAccessIterator>::difference_type len11 = 0;
    typename komrade::iterator_traits<RandomAccessIterator>::difference_type len22 = 0;
    if(len1 > len2)
    {
        len11 = len1 / 2;
                         ...
                         StrictWeakOrdering comp)
{
    ...
    // sort each side
    komrade::sorting::stable_merge_sort(begin, middle, comp);
    komrade::sorting::stable_merge_sort(middle, end, comp);
