                   ...
                   const PostProcess& postprocess)
{
    ...
    komrade::exclusive_scan(komrade::device_ptr<unsigned int>(counters), 
                            komrade::device_ptr<unsigned int>(counters + 16 * numBlocks2),
                            komrade::device_ptr<unsigned int>(countersSum));
...
#define RS_KeyValue(bit,pre,post)                                            \
    ...
    RS_KeyValue( 0, preprocess,                komrade::identity<uint>());
    RS_KeyValue( 4, komrade::identity<uint>(), komrade::identity<uint>());
    RS_KeyValue( 8, komrade::identity<uint>(), komrade::identity<uint>());
    RS_KeyValue(12, komrade::identity<uint>(), komrade::identity<uint>());
    RS_KeyValue(16, komrade::identity<uint>(), komrade::identity<uint>());
    RS_KeyValue(20, komrade::identity<uint>(), komrade::identity<uint>());
    RS_KeyValue(24, komrade::identity<uint>(), komrade::identity<uint>());
    RS_KeyValue(28, komrade::identity<uint>(), postprocess              );
...
#define RS_KeyOnly(bit,pre,post)                                                     \
    ...
    RS_KeyOnly( 0, preprocess,                komrade::identity<uint>());
    RS_KeyOnly( 4, komrade::identity<uint>(), komrade::identity<uint>());
    RS_KeyOnly( 8, komrade::identity<uint>(), komrade::identity<uint>());
    RS_KeyOnly(12, komrade::identity<uint>(), komrade::identity<uint>());
    RS_KeyOnly(16, komrade::identity<uint>(), komrade::identity<uint>());
    RS_KeyOnly(20, komrade::identity<uint>(), komrade::identity<uint>());
    RS_KeyOnly(24, komrade::identity<uint>(), komrade::identity<uint>());
    RS_KeyOnly(28, komrade::identity<uint>(), postprocess              );
...
unsigned int determine_keyBits(const unsigned int * keys,
                               ...
                               const PreProcess& preprocess)
{
    unsigned int max_val = komrade::transform_reduce(komrade::device_ptr<const unsigned int>(keys),
                                                     komrade::device_ptr<const unsigned int>(keys + numElements),
                                                     preprocess,
                                                     (unsigned int) 0,
                                                     komrade::maximum<unsigned int>());
                ...
                unsigned int keyBits = UINT_MAX)
{
    ...
    komrade::device_ptr<unsigned int> temp_keys     = komrade::device_malloc<unsigned int>(numElements);
    komrade::device_ptr<unsigned int> counters      = komrade::device_malloc<unsigned int>(RadixSort::WARP_SIZE * numBlocks);
    komrade::device_ptr<unsigned int> histogram     = komrade::device_malloc<unsigned int>(RadixSort::WARP_SIZE * numBlocks);
    komrade::device_ptr<unsigned int> block_offsets = komrade::device_malloc<unsigned int>(RadixSort::WARP_SIZE * numBlocks);
    ...
    komrade::device_free(temp_keys);
    komrade::device_free(counters);
    komrade::device_free(histogram);
    komrade::device_free(block_offsets);
}
                       ...
                       unsigned int keyBits = UINT_MAX)
{
    ...
    komrade::device_ptr<unsigned int> temp_keys     = komrade::device_malloc<unsigned int>(numElements);
    komrade::device_ptr<unsigned int> temp_values   = komrade::device_malloc<unsigned int>(numElements);
    komrade::device_ptr<unsigned int> counters      = komrade::device_malloc<unsigned int>(RadixSort::WARP_SIZE * numBlocks);
    komrade::device_ptr<unsigned int> histogram     = komrade::device_malloc<unsigned int>(RadixSort::WARP_SIZE * numBlocks);
    komrade::device_ptr<unsigned int> block_offsets = komrade::device_malloc<unsigned int>(RadixSort::WARP_SIZE * numBlocks);
