...
#include <komrade/detail/dispatch/distance.h>
...
template<typename InputIterator>
  inline typename komrade::iterator_traits<InputIterator>::difference_type
    distance(InputIterator first, InputIterator last)
{
  // dispatch on category
  return komrade::detail::dispatch::distance(first,last,
