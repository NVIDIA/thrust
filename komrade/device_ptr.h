...
template<typename T> struct device_ptr
{
  ...
  typedef komrade::random_access_device_iterator_tag iterator_category;
  ...
  private:
    ...
    friend struct komrade::detail::device_dereferenceable_iterator_traits< komrade::device_ptr<T> >;
    ...
    friend struct komrade::detail::make_device_dereferenceable< komrade::device_ptr<T> >;
}; // end device_ptr
...
#include <komrade/detail/device_ptr.inl>
