 ...
 *
 *  \code
 *  struct sine : public komrade::unary_function<float,float>
 *  {
 *    __host__ __device__
 ...
 *
 *  \code
 *  struct exponentiate : public komrade::binary_function<float,float,float>
 *  {
 *    __host__ __device__
...
#include <komrade/detail/functional.inl>
