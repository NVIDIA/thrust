...
#include <komrade/detail/host/transform_scan.h>
#include <komrade/detail/device/cuda/scan.h>
...
template<typename InputIterator,
  ...
  void transform_inclusive_scan(InputIterator begin,
                                ...
                                komrade::forward_host_iterator_tag)
{
    komrade::detail::host::transform_inclusive_scan(begin, end, result, unary_op, binary_op);
}
...
template<typename InputIterator,
  ...
  void transform_exclusive_scan(InputIterator begin,
                                ...
                                komrade::forward_host_iterator_tag)
{
    komrade::detail::host::transform_exclusive_scan(begin, end, result, unary_op, init, binary_op);
}
                                ...
                                komrade::random_access_device_iterator_tag)
{
  ...
  return komrade::detail::device::cuda::inclusive_scan(func, n, (&*result).get(), binary_op);
}
                                ...
                                komrade::random_access_device_iterator_tag)
{
  ...
  // XXX use make_device_dereferenceable here instead of assuming &*result is device_ptr
  return komrade::detail::device::cuda::exclusive_scan(func, n, (&*result).get(), OutputType(init), binary_op);
}
