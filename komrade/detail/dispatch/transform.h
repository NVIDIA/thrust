...
{
  return komrade::detail::host::experimental::transform_if(first, last, stencil, result, unary_op, pred);
} // end transform_if()
...
template<typename InputIterator1,
  ...
  ForwardIterator transform_if(InputIterator1 first1, InputIterator1 last1,
                               ...
                               komrade::forward_host_iterator_tag)
{
  return komrade::detail::host::experimental::transform_if(first1, last1, first2, stencil, result, unary_op, pred);
} // end transform_if()
