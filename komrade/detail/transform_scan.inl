...
#include <komrade/detail/dispatch/transform_scan.h>
                                ...
                                AssociativeOperator binary_op)
{
    ...
    komrade::detail::dispatch::transform_inclusive_scan(first, last, result, unary_op, binary_op,
                                ...
                                AssociativeOperator binary_op)
{
    ...
    komrade::detail::dispatch::transform_exclusive_scan(first, last, result, unary_op, init, binary_op,
            typename komrade::iterator_traits<InputIterator>::iterator_category(),
            typename komrade::iterator_traits<OutputIterator>::iterator_category());
}
