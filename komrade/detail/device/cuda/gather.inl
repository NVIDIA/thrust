              ...
              RandomAccessIterator input)
{
  ...
  typedef typename komrade::iterator_traits<RandomAccessIterator>::value_type InputType;
...
{
  typedef typename komrade::iterator_traits<ForwardIterator>::value_type OutputType;
  typedef typename komrade::iterator_traits<InputIterator1>::value_type IndexType;
  typedef typename komrade::iterator_traits<InputIterator2>::value_type PredicateType;
  typedef typename komrade::iterator_traits<RandomAccessIterator>::value_type InputType;
