...
{
    if(begin != end) {
        typename komrade::iterator_traits<OutputIterator>::value_type last;
...
{
    if(begin != end) {
        typename komrade::iterator_traits<OutputIterator>::value_type temp = *begin;
        typename komrade::iterator_traits<OutputIterator>::value_type next =  init;
