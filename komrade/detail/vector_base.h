  ...
  public:
    ...
    class iterator
      : public experimental::iterator_adaptor<iterator,
                                              pointer,
                                              value_type,
                                              typename komrade::iterator_traits<pointer>::iterator_category,
                                              reference,
                                              pointer,
                                              difference_type>
    {
      public:
        ...
        typedef experimental::iterator_adaptor<device_dereferenceable_type,
                                               ...
                                               typename komrade::iterator_traits<device_dereferenceable_pointer>::value_type,
                                               typename komrade::iterator_traits<device_dereferenceable_pointer>::iterator_category,
                                               typename komrade::iterator_traits<device_dereferenceable_pointer>::reference,
                                               typename komrade::iterator_traits<device_dereferenceable_pointer>::pointer,
                                               typename komrade::iterator_traits<device_dereferenceable_pointer>::difference_type> device_dereferenceable_type_base;
      ...
      private:
        ...
        friend struct komrade::detail::device_dereferenceable_iterator_traits<iterator>;
        ...
        friend struct komrade::detail::make_device_dereferenceable<iterator>;
    }; // end iterator
    ...
    class const_iterator
      : public experimental::iterator_adaptor<const_iterator,
                                              const_pointer,
                                              value_type,
                                              typename komrade::iterator_traits<const_pointer>::iterator_category,
                                              const_reference,
                                              const_pointer,
                                              difference_type>
    {
      ...
      private:
        // befriend device_dereferenceable_iterator_traits so he can get at device_dereferenceable_type
        friend struct komrade::detail::device_dereferenceable_iterator_traits<const_iterator>;
        ...
        // befriend make_device_dereferenceable so he can get at device_dereferenceable()
        friend struct komrade::detail::make_device_dereferenceable<const_iterator>;
    }; // end iterator
...
#include <komrade/detail/vector_base.inl>
