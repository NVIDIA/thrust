...
#include <komrade/detail/dispatch/scatter.h>
               ...
               RandomAccessIterator output)
{
  ...
  komrade::detail::dispatch::scatter(first, last, map, output,
                  ...
                  RandomAccessIterator output)
{
  ...
  typedef typename komrade::iterator_traits<InputIterator3>::value_type StencilType;
  scatter_if(first, last, map, stencil, output, komrade::identity<StencilType>());
} // end scatter_if()
...
{
  // dispatch on category
  komrade::detail::dispatch::scatter_if(first, last, map, stencil, output, pred,
    typename komrade::iterator_traits<InputIterator1>::iterator_category(),
    typename komrade::iterator_traits<InputIterator2>::iterator_category(),
