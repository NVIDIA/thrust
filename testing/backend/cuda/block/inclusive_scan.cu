...
struct block_inclusive_scan_closure
{
  ...
  void operator()(void)
  {
    thrust::detail::backend::cuda::extern_shared_ptr<ValueType> shared_array;
    ...
    thrust::detail::backend::cuda::block::inclusive_scan_n(context, &shared_array[0], context.block_dimension(), thrust::plus<int>());
...
{
  thrust::detail::backend::cuda::arch::device_properties_t   properties = thrust::detail::backend::cuda::arch::device_properties();
  thrust::detail::backend::cuda::arch::function_attributes_t attributes = thrust::detail::backend::cuda::detail::closure_attributes<Closure>();
...
void test_inclusive_scan(size_t block_size)
{
  ...
  size_t smem_bytes = sizeof(ValueType) * block_size;
   ...
   if (is_valid_launch<Closure>(1, block_size, smem_bytes))
   {
     ...
     thrust::detail::backend::cuda::detail::launch_closure
...
{
  typedef thrust::detail::backend::cuda::detail::statically_blocked_thread_array<block_size>  Context;
...
{
  typedef thrust::detail::backend::cuda::detail::blocked_thread_array Context;
  test_inclusive_scan<Context>(block_size);
}
