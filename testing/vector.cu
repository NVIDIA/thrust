...
VectorUnitTest<TestVectorRangeInsertSimple, NumericTypes, thrust::device_vector, thrust::device_allocator> TestVectorRangeSimpleDeviceInstance;
VectorUnitTest<TestVectorRangeInsertSimple, NumericTypes, thrust::host_vector,   std::allocator>   TestVectorRangeSimpleHostInstance;
...
VariableUnitTest<TestVectorRangeInsert, IntegralTypes> TestVectorRangeInstance;
